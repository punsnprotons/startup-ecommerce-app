...
const HomeScreen = () => {
    ...
    const [items, setItems] = useState([
        ...
        { label: 'jewelery', value: 'jewelwery' },
        ...
        <>
            <SafeAreaView style={{ paddingTop: Platform.OS === "android" ? 40 : 0, flex: 1, backgroundColor: "white" }}>
                <ScrollView>
                    ...
                    <Pressable onPress={() => setModalVisible(!modalVisible)} style={{ flexDirection: 'row', alignItems: 'center', gap: 10, padding: 10, backgroundColor: '#AFEEEE' }}>
                    ...
                    <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                        ...
                        {offers.map((item, index) => (
                            <Pressable onPress={() => navigation.navigate('Info', {
                                ...
                                oldPrice: item?.oldPrice,
                                item: item,
                            })} key={index} style={{ marginVertical: 10, justifyContent: 'center', alignItems: 'center' }}>
                                ...
                                <View style={{ backgroundColor: '#E31837', paddingVertical: 5, width: 130, justifyContent: 'center', alignItems: 'center', marginTop: 10, borderRadius: 4, }}>
                                    <Text style={{ textAlign: 'center', color: 'white', fontSize: 13, fontWeight: '500' }}>{item.offer}</Text>
                                </View>
                            </Pressable>
                        ))}
                ...
                <ModalContent style={{ width: '100%', height: 400 }}>
                    ...
                    <View style={{ flexDirection: 'column', gap: 7, marginBottom: 30 }}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 5 }}>
                            ...
                            <Text style={{ color: '#0066b2', fontWeight: '400' }}>Enter an Pakistan pincode</Text>
                        </View>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 5 }}>
                            ...
                            <Text style={{ color: '#0066b2', fontWeight: '400' }}>Deliver outside of Pakistan</Text>
                        </View>
